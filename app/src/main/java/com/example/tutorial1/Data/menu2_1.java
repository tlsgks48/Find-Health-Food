...
public class menu2_1 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView1 = (TextView)findViewById(R.id.mon4_1_star_off);
        final ImageView imageView1 = (ImageView)findViewById(R.id.mon4_1_image_star);
        final LinearLayout linearLayout1 = (LinearLayout)findViewById(R.id.mon4_1_Linear_star_off);

        mRecyclerView = (RecyclerView) findViewById(R.id.mon4_1_recyclerview_main_list);
        mLinearLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);

        // mon1_1 액티비티에서 리사이클러뷰의 데이터에 접근시 사용.
        //mArrayList_mon4_1 = new ArrayList<>();
        loadData();

        mAdapter = new Mon1_1_Adapter(this,mArrayList_mon4_1,8);
        ...
        // 유저에 따른 별값
        int aa = user_star.getInt(user_email.getString("Login_email","")+"8",0);

        // 앱에 따른 고정적 별값
        b = app_food.getInt("a8",0);
        mon4_1OnOff = aa;
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mon4_1OnOff == 0) {
                    mon4_1OnOff = 1;
                    editor.putInt(user_email.getString("Login_email","")+"8",1);
                    editor.apply();
                    editor2.putInt(user_email.getString("Login_email","")+"8",MonPosition1_1);
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_on);
                    Toast.makeText(menu2_1.this, "관심 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                }
                else {
                    mon4_1OnOff = 0;
                    editor.putInt(user_email.getString("Login_email","")+"8",0);
                    editor.apply();
                    editor2.remove(user_email.getString("Login_email","")+"8");
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_off);
                    Toast.makeText(menu2_1.this, "관심 등록이 해제 되었습니다. ", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button buttonInsert = (Button)findViewById(R.id.mon4_1_comment_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText)findViewById(R.id.mon4_1editText_comment);
                ...
                mArrayList_mon4_1.add(dict);
                mAdapter.notifyDataSetChanged(); // 추가한것을 리사이클러뷰에 적용.
                saveData();
                int t = app_food.getInt("c8",0) + 1;
                editor3.putInt("c8",t);
                editor3.apply();
    ...
    private void saveData() {
        ...
        Gson gson = new Gson();
        String json = gson.toJson(mArrayList_mon4_1);
        editor.putString("a"+"8", json);
        editor.apply();
    }
    ...
    private void loadData() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("user_mon_comment",MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("a"+"8", null);
        Type type = new TypeToken<ArrayList<Mon1_1_Item>>() {}.getType();
        mArrayList_mon4_1 = gson.fromJson(json, type);

        if (mArrayList_mon4_1 == null) {
            mArrayList_mon4_1 = new ArrayList<>();
        }
    }
}