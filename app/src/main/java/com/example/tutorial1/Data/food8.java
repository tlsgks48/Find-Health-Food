...
public class food8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView1 = (TextView)findViewById(R.id.food8_star_off);
        final ImageView imageView1 = (ImageView)findViewById(R.id.food8_image_star);
        final LinearLayout linearLayout1 = (LinearLayout)findViewById(R.id.food8_Linear_star_off);

        mRecyclerView = (RecyclerView) findViewById(R.id.food8_recyclerview_main_list);
        mLinearLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);

        // mon1_1 액티비티에서 리사이클러뷰의 데이터에 접근시 사용.
        //mArrayList_food8 = new ArrayList<>();
        loadData();

        mAdapter = new Food_Adapter(this,mArrayList_food8,7);
        ...
        // 유저에 따른 별값
        int aa = user_star.getInt(user_email.getString("Login_email","")+"7",0);

        // 앱에 따른 고정적 별값
        b = app_food.getInt("a7",0);
        food8_OnOff = aa;
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(food8_OnOff == 0) {
                    food8_OnOff = 1;
                    editor.putInt(user_email.getString("Login_email","")+"7",1);
                    editor.apply();
                    editor2.putInt(user_email.getString("Login_email","")+"7",MonPosition_food1);
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_on);
                    Toast.makeText(food8.this, "관심 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                }
                else {
                    food8_OnOff = 0;
                    editor.putInt(user_email.getString("Login_email","")+"7",0);
                    editor.apply();
                    editor2.remove(user_email.getString("Login_email","")+"7");
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_off);
                    Toast.makeText(food8.this, "관심 등록이 해제 되었습니다. ", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button buttonInsert = (Button)findViewById(R.id.food8_comment_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText)findViewById(R.id.food8_editText_comment);
                ...
                mArrayList_food8.add(dict);
                mAdapter.notifyDataSetChanged(); // 추가한것을 리사이클러뷰에 적용.
                saveData();
                int t = app_food.getInt("c7",0) + 1;
                editor3.putInt("c7",t);
                editor3.apply();
    ...
    private void saveData() {
        ...
        Gson gson = new Gson();
        String json = gson.toJson(mArrayList_food8);
        editor.putString("a"+"7", json);
        editor.apply();
    }
    ...
    private void loadData() {
        ...
        SharedPreferences sharedPreferences = getSharedPreferences("user_food_comment",MODE_PRIVATE);
        Gson gson = new Gson();
        String json = sharedPreferences.getString("a"+"7", null);
        Type type = new TypeToken<ArrayList<Mon1_1_Item>>() {}.getType();
        mArrayList_food8 = gson.fromJson(json, type);

        if (mArrayList_food8 == null) {
            mArrayList_food8 = new ArrayList<>();
        }
    }
}
