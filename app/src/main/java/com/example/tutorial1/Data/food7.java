...
public class food7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView1 = (TextView)findViewById(R.id.food7_star_off);
        final ImageView imageView1 = (ImageView)findViewById(R.id.food7_image_star);
        final LinearLayout linearLayout1 = (LinearLayout)findViewById(R.id.food7_Linear_star_off);

        mRecyclerView = (RecyclerView) findViewById(R.id.food7_recyclerview_main_list);
        mLinearLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);

        // mon1_1 액티비티에서 리사이클러뷰의 데이터에 접근시 사용.
        //mArrayList_food7 = new ArrayList<>();
        loadData();

        mAdapter = new Food_Adapter(this,mArrayList_food7,6);
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(food7_OnOff == 0) {
                    ...
                    editor.apply();
                    editor2.putInt(user_email.getString("Login_email","")+"6",MonPosition_food1);
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_on);
                    Toast.makeText(food7.this, "관심 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                }
                else {
                    food7_OnOff = 0;
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_off);
                    Toast.makeText(food7.this, "관심 등록이 해제 되었습니다. ", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button buttonInsert = (Button)findViewById(R.id.food7_comment_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText)findViewById(R.id.food7_editText_comment);
    ...
    private void saveData() {
        ...
        Gson gson = new Gson();
        String json = gson.toJson(mArrayList_food7);
    ...
    private void loadData() {
        ...
        mArrayList_food7 = gson.fromJson(json, type);

        if (mArrayList_food7 == null) {
            mArrayList_food7 = new ArrayList<>();
        }
    }
}
