...
public class food5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final TextView textView1 = (TextView)findViewById(R.id.food5_star_off);
        final ImageView imageView1 = (ImageView)findViewById(R.id.food5_image_star);
        final LinearLayout linearLayout1 = (LinearLayout)findViewById(R.id.food5_Linear_star_off);

        mRecyclerView = (RecyclerView) findViewById(R.id.food5_recyclerview_main_list);
        mLinearLayoutManager = new LinearLayoutManager(this);
        mRecyclerView.setLayoutManager(mLinearLayoutManager);

        // mon1_1 액티비티에서 리사이클러뷰의 데이터에 접근시 사용.
        //mArrayList_food5 = new ArrayList<>();
        loadData();

        mAdapter = new Food_Adapter(this,mArrayList_food5,4);
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(food5_OnOff == 0) {
                    ...
                    editor.apply();
                    editor2.putInt(user_email.getString("Login_email","")+"4",MonPosition_food1);
                    editor2.apply();
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_on);
                    Toast.makeText(food5.this, "관심 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                }
                else {
                    food5_OnOff = 0;
                    ...
                    editor3.apply();
                    imageView1.setImageResource(R.drawable.star_off);
                    Toast.makeText(food5.this, "관심 등록이 해제 되었습니다. ", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button buttonInsert = (Button)findViewById(R.id.food5_comment_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText)findViewById(R.id.food5_editText_comment);
    ...
    private void saveData() {
        ...
        Gson gson = new Gson();
        String json = gson.toJson(mArrayList_food5);
    ...
    private void loadData() {
        ...
        mArrayList_food5 = gson.fromJson(json, type);

        if (mArrayList_food5 == null) {
            mArrayList_food5 = new ArrayList<>();
        }
    }
}
