...
public class mon1_1 extends AppCompatActivity {
    public static ArrayList<Mon1_1_Item> mArrayList;
    public static Mon1_1_Adapter mAdapter;
    public static RecyclerView mRecyclerView;
    public static LinearLayoutManager mLinearLayoutManager;
    private int count = -1;

    public static int mon1_1OnOff = 0; // 관심 등록됬는지
    public int b = 0;
    String mtext="";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.mon1_1);
        MonPosition1_1 = getIntent().getIntExtra("position2",9); // 포지션 값을 받았는지...

        final TextView textView1 = (TextView)findViewById(R.id.mon1_1_star_off);
        final ImageView imageView1 = (ImageView)findViewById(R.id.mon1_1_image_star);
        final LinearLayout linearLayout1 = (LinearLayout)findViewById(R.id.mon1_1_Linear_star_off);

        mRecyclerView = (RecyclerView) findViewById(R.id.mon1_1_recyclerview_main_list);
        ...
        mAdapter = new Mon1_1_Adapter(this,mArrayList,1);
        ...
        linearLayout1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(mon1_1OnOff == 0) {
                    ...
                    editor.apply();
                    editor2.putInt(user_email.getString("Login_email","")+"1",MonPosition1_1);
                    editor2.apply();
                    ...
                    imageView1.setImageResource(R.drawable.star_on);
                    Toast.makeText(mon1_1.this, "관심 등록 되었습니다.", Toast.LENGTH_SHORT).show();
                }
                else {
                    mon1_1OnOff = 0;
                    ...
                    imageView1.setImageResource(R.drawable.star_off);
                    Toast.makeText(mon1_1.this, "관심 등록이 해제 되었습니다. ", Toast.LENGTH_SHORT).show();
                }
            }
        });

        Button buttonInsert = (Button)findViewById(R.id.mon1_1_comment_insert);
        buttonInsert.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                EditText editText = (EditText)findViewById(R.id.mon1_1editText_comment);
