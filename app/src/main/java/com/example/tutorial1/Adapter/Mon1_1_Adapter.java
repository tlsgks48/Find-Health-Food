...
public class Mon1_1_Adapter extends RecyclerView.Adapter<Mon1_1_Adapter.Mon1_1ViewHolder> {
    ...
    public class Mon1_1ViewHolder extends RecyclerView.ViewHolder implements View.OnCreateContextMenuListener{
        protected TextView id;
        protected TextView user;
        protected TextView time;

        public Mon1_1ViewHolder(@NonNull View view) {
            super(view);
                ...
                switch (item.getItemId()) {
                    ...
                    case 1002:
                        ...
                        if(mList.get(getAdapterPosition()).getUser().equals(user_email2.getString("Login_email","")+"님")) {
                            ...
                            saveData();
                            SharedPreferences app_food = mcontext.getSharedPreferences("app_attention", Context.MODE_PRIVATE);
    ...
    public Mon1_1_Adapter(Context context,ArrayList<Mon1_1_Item> list, int ii) {
    ...
    @NonNull
    @Override
    public Mon1_1ViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int viewType) {
        View view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.mon1_1_item,viewGroup,false);
        Mon1_1ViewHolder viewHolder = new Mon1_1ViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull Mon1_1ViewHolder viewholder, int position) {
    ...
    private void saveData() {
        SharedPreferences user_email = mcontext.getSharedPreferences("user_email",Context.MODE_PRIVATE);
        SharedPreferences sharedPreferences = mcontext.getSharedPreferences("user_mon_comment",Context.MODE_PRIVATE);
